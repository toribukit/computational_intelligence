...
def run_evolution(
    ...
    for i in range(generation_limit):
        ...
        print(f"fitness: {fitness_avg(population[0], field_cost, field_qty, NUM_FIELDS, NUM_PLANTS, PRODUCTION_QTY, plant_cost)}")
...
population, generation = run_evolution(
    ...
    fitness_func=partial(
        fitness_avg, cost_f=field_cost, qty_f=field_qty, field_per_plant=NUM_FIELDS, num_plant=NUM_PLANTS, total_qty=PRODUCTION_QTY, cost_p=plant_cost, eval_round=EVAL_ROUND
    ),
